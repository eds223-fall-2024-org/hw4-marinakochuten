...
- Other conditions that may effect suitability for marine aquaculture other than sea surface temperature and depth are not considered in this analysis.
- The data I used to calculate sea surface temperature is from 2008-2012. With rising sea temperatures, it is very possible that the average sea surface temperature today is different than the one used in this analysis. It would be important to consider newer sst data in further analysis. 
